...
namespace Learun.Application.Web.Areas.ERPDemo.Controllers
{
    ...
    /// 描 述：单据历史
    /// </summary>
    public class DataHistoryController : MvcControllerBase
    {
        private DataHistoryIBLL dataHistoryIBLL = new DataHistoryBLL();
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dataHistoryIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
