...
namespace Learun.Application.Web.Controllers
{
    ...
    public class HomeController : MvcControllerBase
    {
        ...
        public ActionResult AdminDesktop()
        {
            ...
            {
                case "1":
                    return View("DesktopDefault");      // 经典版本
                case "2":
                    return View("DesktopAccordion");    // 手风琴版本
                case "3":
                    return View("DesktopWindos");       // Windos版本
                case "4":
                    return View("DesktopTop");          // 顶部菜单版本
                case "5":
                    return View("DesktopDefault");      // 主题五
                default:
                    return View("DesktopDefault");      // 经典版本
            }
        }
