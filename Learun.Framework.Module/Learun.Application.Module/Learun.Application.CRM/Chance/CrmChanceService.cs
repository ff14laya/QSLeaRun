...
namespace Learun.Application.CRM
{
    ...
    public class CrmChanceService : RepositoryFactory
    {
        ...
        /// <summary>
        /// <returns></returns>
        public IEnumerable<CrmChanceEntity> GetList()
        {
            ...
            strSql.Append(@"
                ...
                F_CreateDate
                ");
            strSql.Append("  FROM LR_CRM_Chance where F_DealDate is not null and F_Amount is not null and F_SuccessRate is not null and F_Profit is not null");
            return this.BaseRepository().FindList<CrmChanceEntity>(strSql.ToString());
        }
        /// <summary>
        /// 获取列表
        /// </summary>
